                      ...
                      <div className="total-box">
                        <div className="row g-sm-4 g-3">
                          ...
                          <div className="col-xxl-3 col-lg-6 col-md-3 col-sm-6">
                            <div className="total-contain">
                              <div className="total-detail">
                                <h5 style={{ fontSize: "20px" }}>Processing</h5>
                                <h3>{order_count?.processing_order || 0}</h3>
                              </div>
                            </div>
                          </div>
                          <div className="col-xxl-3 col-lg-6 col-md-3 col-sm-6">
                            <div className="total-contain">
                              <div className="total-detail">
                                <h5 style={{ fontSize: "20px" }}>Delivered</h5>
                                <h3>{order_count?.delivered_order || 0}</h3>
                              </div>
                            </div>
                          </div>
                          <div className="col-xxl-3 col-lg-6 col-md-3 col-sm-6">
                          ...
                          <div className="col-xxl-3 col-lg-6 col-md-3 col-sm-6">
                            <div className="total-contain">
                              <div className="total-detail">
                                ...
                                <h3 style={{ color: "green" }}>
                                  ₹ {company?.used_wallet || (0).toFixed(2)}
                                </h3>
                              </div>
                            </div>
                          </div>
